 ...
 * @author cssco
 */
@WebServlet(name = "GreeterMessage", urlPatterns = {"/greeter"})
public class WelcomeMessageGreeterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String msg = ws.getMessage(nameEntered);
